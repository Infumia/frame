...
import net.infumia.inv.core.element.ElementItemBuilderImpl;
...
import net.infumia.inv.core.pipeline.executor.PipelineExecutorRenderImpl;
import net.infumia.inv.core.pipeline.executor.PipelineExecutorViewerImpl;
...
public class ContextRenderImpl extends ContextBaseImpl implements ContextRenderRich {
    ...
    public ContextRenderImpl(@NotNull final ContextRenderRich context) {
        super(context);
