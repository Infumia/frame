...
import net.infumia.inv.core.pipeline.context.PipelineContextManagers;
import net.infumia.inv.core.pipeline.holder.PipelineHolderManager;
...
public final class PipelineExecutorManagerImpl implements PipelineExecutorManager {
    ...
    public PipelineExecutorManagerImpl(@NotNull final InventoryManagerRich manager) {
